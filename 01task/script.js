...
const roundLessPencil = Math.floor(pencil);
...
Round to less price of pencil is ${roundLessPencil};
Round to less price of notebook is ${roundLessNotebook};
Round to less price of pen is ${roundLessPen};
Sum of items round less to price ${sumRoundLessPenn};
Round to 100 Total sum of products ${moreSumProducts};
Sum of items is even number ${priceBool};
