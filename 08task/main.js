...
class Student {
  ...
  getInfo () {
    ...
    getAverageMark () {
      ...
      console.log(`Середня оцінка навчання: ${res}, студент: ${this.fullName};`);

      const res1 = Math.round (res);
      return `Середня округлена оцінка навчання ${res1}, студент: ${this.fullName}`;
    }
...
class BudgetStudent extends Student {
  ...
  getScholarship () {
    ...
    return console.log(`Вам нараховано 1400 грн.`);
  }
}
